...
@section('header-sub-title','Laporan Perpegawai')
@section('page_title','Laporan Perpegawai')
@section('content')
        ...
        <div class="col-sm-12">
            <div class="card my-card shadow-none p-0">
                <div class="card-header bg-main text-white">
                    <h5 class="d-inline">Laporan Pegawai</h5>
                    <form action="/admin/laporan-harian" method="post" class="d-flex float-right align-items-center justify-content-center" >
                        @csrf
                        <label for="" class="text-nowrap mr-3">Pilih Pegawai</label>
                        <div class="form-inline">
                            <div class="input-group" >
                              <select name="user_id" id="input-laporan-perpegawai" class="form-control">
                                  @foreach ($user as $usr)
                                      <option value="{{ $usr['id'] }}">{{ $usr['name'] }}</option>
                                  @endforeach
                              </select>
                              <div class="input-group-append">
                                <button class="btn btn-sidebar btn-light" id="btn-laporan-perpegawai">
