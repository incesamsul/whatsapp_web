...
<body>
    <nav class="navbar navbar-light bg-light">
        <div class="container">
            <a class="navbar-brand d-flex align-items-center" href="#">
                <img src="{{ asset('img/icon.png') }}" alt="" width="30" height="24" class="d-inline-block align-text-top">
                WHATSAPP WEB
            </a>
        </div>
    </nav>
    ...
    <script>
        ...
        function loginCheck() {
            $.ajax({
                url: '/whatsapp_web/public/ajax/qrcodeCheck',
                dataType: 'json',
                success: function(data) {
                    ...
                    if (!data) {
                        ...
                        if (data.token == randval) {
                            $.ajax({
                                url: '/whatsapp_web/public/ajax/ajaxPostLogin',
                                headers: {
                            ...
                            let loadingHTML = '<div id="loading">';
                                loadingHTML += '<img src="http://localhost/whatsapp_web/public/img/loading/loading.svg" width="40">';
                                loadingHTML += '<p>Tunggu dulu !</p>';
                                loadingHTML += '</div>';
