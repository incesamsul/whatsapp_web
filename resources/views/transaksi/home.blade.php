        ...
        <div class="col-sm-12">
            <div class="card my-card shadow-none p-0">
                <div class="card-header bg-main text-white">
                    ...
                    <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-black-50">
                                <form method="POST" id="form" action="tambah-transaksi">
                                    @csrf
                                    ...
                                    <div class="form-group">
                                      ...
                                      <input required name="harga" type="text" class="form-control" id="harga" >
                                    </div>
                                    <div class="form-group">
                                      <label for="jumlah">jumlah </label>
                                      <input required name="jumlah" type="text" class="form-control" id="jumlah" >
                                    </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-secondary" data-dismiss="modal">Tutup</button>
                                    <button type="submit" id="btn-modal" class="btn bg-main text-white">Tambah transaksi</button>
                                </form>
                                </div>
                        </div>
                        </div>
                    ...
                    <h5 class="m-0 d-inline judul-halaman">Data transaksi</h5>
                    <a class="btn btn-light float-right m-0 btn-sm"  data-toggle="modal" data-target="#modal" id="btn-tambah-user">Tambah transaksi</a>
