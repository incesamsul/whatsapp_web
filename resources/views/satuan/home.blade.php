        ...
        <div class="col-sm-12">
            <div class="card my-card shadow-none p-0">
                <div class="card-header bg-main text-white">
                    ...
                    <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <div class="modal-body text-black-50">
                                <form method="POST" id="form" action="tambah-satuan">
                                    @csrf
                                ...
                                <div class="modal-footer">
                                    ...
                                    <button type="submit" id="btn-modal" class="btn bg-main text-white">Tambah satuan</button>
                                </form>
                                </div>
                        </div>
                        </div>
                    ...
                    <h5 class="m-0 d-inline judul-halaman">Data satuan</h5>
                    <a class="btn btn-light float-right m-0 btn-sm"  data-toggle="modal" data-target="#modal" id="btn-tambah-user">Tambah satuan</a>
