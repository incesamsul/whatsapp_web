                ...
                <div class="card-header bg-main text-white">
                    ...
                    <div class="modal fade" id="modal" tabindex="-1" aria-labelledby="modalLabel" aria-hidden="true">
                        ...
                        <div class="modal-content">
                            ...
                            <h5 class="modal-title " id="modalLabel">Tambah stok masuk</h5>
                            <button type="button" class="close text-white" data-dismiss="modal" aria-label="Close">
                                <span aria-hidden="true">&times;</span>
                            </button>
                            </div>
                            <div class="modal-body text-black-50">
                                <form method="POST" id="form" action="tambah-stok_masuk">
                                    @csrf
                    ...
                    <h5 class="m-0 d-inline judul-halaman">Data stok masuk</h5>
                    <a class="btn btn-light float-right m-0 btn-sm"  data-toggle="modal" data-target="#modal" id="btn-tambah-user">Tambah stok masuk</a>
